...
const Brand = () => {
   ...
   return (
      blog && (
         <div dir={ar ? "rtl" : "ltr"} className="container my-8 space-y-8">
            <nav
               ...
               >
                  ...
                  {blog.comments != 0 ? (
                     ...
                     <p className="text-left text-gray-500">
                        {ar
                           ? "لا توجد تعليقات في هذه المدونة حتى الآن."
               ...
               <div className="col-span-6 md:col-span-2 p-2 md:p-4 bg-gray-50 rounded-lg shadow-lg h-fit">
                  <div>
                     <textarea
                        ...
                        id="comment"
                        rows={4}
                        className={`outline-none block p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border ${
                           commentErr ? "border-red-700" : "border-gray-300"
                        } focus:border-primary-100`}
                        placeholder={
                           ar ? "اترك تعليقك..." : "Leave your comment..."
                        }
                        defaultValue={""}
                     />
                     <button
